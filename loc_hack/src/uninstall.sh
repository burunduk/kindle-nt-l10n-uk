...
logmsg "I" "update" "Remove uk.properties"
update_progressbar 10
rm -f /opt/amazon/ebook/config/locales/uk.properties

logmsg "I" "update" "Remove uk.conf & whitelist entries"
update_progressbar 20
rm -f /opt/amazon/dict/conf/uk.conf
