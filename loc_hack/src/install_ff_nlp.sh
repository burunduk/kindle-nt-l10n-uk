...
/usr/java/bin/cvm -Xms16m -classpath bcel-5.2.jar:K3Translator.jar Translator td4 ${ORIGFOLDER_LIB} translation_nlp.jar en_GB uk >> ${INST_LOG} 2>&1
...
mv -f *-uk_UA.jar ${ORIGFOLDER_LIB} >> ${INST_LOG} 2>&1
